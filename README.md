# Vision_ML_Excercise_counter
This repository contains my project that uses Pose detection TenforflowJs model to count the number of repetitions of Exercise the Person is doing Live
